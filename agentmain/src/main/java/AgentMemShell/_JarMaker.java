...
public class _JarMaker {
    ...
    public static void main(String[] args) throws Throwable{
        makePremainJar(AgentDemo.class,"agentmain.jar","./agentmain/src/main/java/AgentMemShell/libs");
    }

    public static void makePremainJar(Class compileClass, String jarName, String libPath) throws Throwable {
        String jarFilePath = "agentmain/src/main/java/AgentMemShell/jars/" + jarName;
